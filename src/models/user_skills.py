...
class Category(Base):
    ...
    # Relationship до skills
    skills: Mapped[list["Skill"]] = relationship("Skill", back_populates="category_obj", lazy="selectin")
...
class Skill(Base):
    ...
    # Завдання 4: зв'язок з категорією
    ...
    category_obj: Mapped["Category"] = relationship("Category", back_populates="skills", lazy="selectin")
