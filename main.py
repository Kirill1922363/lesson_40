...
from src.routes.exchanges import router as exchanges_router
...
# Нові роутери (завдання 1-4)
app.include_router(users_router)       # Завдання 1: розширений User
app.include_router(stats_router)       # Завдання 2: статистика
app.include_router(exchanges_router)   # Завдання 3: exchanges з фільтрацією
app.include_router(categories_router)  # Завдання 4: CRUD категорій
